...
export function Layout() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#0b0618] via-[#120a2a] to-[#0a1628] text-slate-100">
      <header className="sticky top-0 z-40 border-b border-amber-500/30 bg-[#0b0618]/90 backdrop-blur-md">
        <div className="max-w-5xl mx-auto px-4 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="font-bold text-lg text-amber-300 tracking-wide">Arcanes Packs</h1>
